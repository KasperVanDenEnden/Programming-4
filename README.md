...
```
cd existing_repo
git remote add origin https://gitlab.com/programming30/programming-4.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/programming30/programming-4/-/settings/integrations)
